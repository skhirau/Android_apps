...
*/
        ...
        WordAdapter phrasesAdapter = new WordAdapter (PhrasesActivity.this,phrases,R.color.category_phrases);
        final ListView phrasesLV = (ListView) PhrasesActivity.this.findViewById(R.id.numbers_list_view);
        phrasesLV.setAdapter(phrasesAdapter);

        phrasesLV.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            @Override
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                Word currentWord = (Word) phrasesLV.getItemAtPosition(position);
